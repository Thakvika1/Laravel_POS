...
<div class="invoice">
    ...
    {{-- Status --}}
    <div class="inv-status status-{{ $order->status }}">
    ...
    <div style="padding:16px 40px;background:#fffbeb;border-top:1px solid #fef3c7;">
        <p style="font-size:12px;color:#92400e;"><strong>Note:</strong> {{ $order->notes }}</p>
    </div>
    @endif

    {{-- Footer --}}
    <div class="inv-footer">
        <p>Thank you for your purchase! · Generated by SwiftPOS on {{ now()->format('M d, Y') }}</p>
    </div>
</div>

<div class="print-bar">
    <a href="{{ route('orders.show', $order) }}" class="back-btn">← Back</a>
