        ...
        <div class="products-panel">
            <div class="product-grid" id="productGrid">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="pos-product <?php echo e($product->qty === 0 ? 'oos' : ''); ?>" data-id="<?php echo e($product->id); ?>"
                        data-name="<?php echo e($product->name); ?>" data-price="<?php echo e($product->price); ?>" data-stock="<?php echo e($product->qty); ?>"
                        data-search="<?php echo e(strtolower($product->name . ' ' . $product->category)); ?>" onclick="addToCart(this)">
                        ...
                        <?php endif; ?>
                        <div class="pp-body">
                            <div class="pp-name"><?php echo e($product->name); ?></div>
                            <div class="pp-price">$<?php echo e(number_format($product->price, 2)); ?></div>
                            <div class="pp-qty"><?php echo e($product->qty > 0 ? 'Stock: ' . $product->qty : 'Out of stock'); ?></div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thakvika\Downloads\pos-laravel\pos-laravel\resources\views/orders/create.blade.php ENDPATH**/ ?>