...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;">
            <input type="text" name="search" class="form-control" placeholder="Search products…" value="<?php echo e(request('search')); ?>" style="max-width:280px;">
            ...
            <div class="pc-body">
                ...
                <div class="pc-qty">
                    ...
                    <?php if($product->category): ?>
                        <span class="badge badge-purple" style="margin-left:4px;"><?php echo e($product->category); ?></span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="pc-footer">
                <a href="<?php echo e(route('products.edit', $product)); ?>" class="btn btn-secondary btn-sm">Edit</a>
                <form method="POST" action="<?php echo e(route('products.destroy', $product)); ?>" onsubmit="return confirm('Delete this product?')">
